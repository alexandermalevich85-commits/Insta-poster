...
_TOPIC_KEYWORDS = {
    "ДЕТИ": [
        ...
        "новорожд", "родител", "няня", "грудн", "кормл", "бабушк",
    ],
    "КОРОЛЕВА": [
        "психолог", "отношен", "ваш муж", "твой муж", "её муж", "мужа ",
        "манипулят", "абьюз", "нарцисс",
        "токсичн", "развод", "измен", "ревност", "обид", "самооценк", "уверенн",
        "границ", "тревожн", "депресси", "выгоран",
        "провокац", "конфликт", "ссор", "предложение выйти замуж",
        "ждать звонка", "удобной для подруг",
    ],
}
